...
def extract_entry(text: str, closed: bool = False, **kwargs) -> List[Focus]:
    if closed:
...
def _opened_extract(text: str) -> List[Entity]:
    # TODO
    pass
...
def _postprocessing(batch_results, excludes: List[str]) -> List[Focus]:
    focuses: List[Focus] = []
